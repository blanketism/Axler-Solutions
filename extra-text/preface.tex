...
\begin{itemize}
    ...
    \item \note{Small excerpts written by Axler that either provide a reference to some term used in the problem, or offer additional context or clarification relevant to understanding the exercise. I have abstained from including every note provided.}
