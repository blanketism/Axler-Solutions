...
\begin{exercise}{5c14}
    ...
    \remark{This can be argued by noting that $\mcal(T^t) = \mcal(T)^t$, so the matrix of $T'$ with respect to the dual basis is lower-triangular. Then the reversed dual basis gives an upper-triangular matrix for $T'$.}
\end{exercise}
