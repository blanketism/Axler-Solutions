...
\begin{sol}
    Let $n=\dim V$ and let $p(z)=z^d+a_{d-1}z^{d-1}+\cdots+a_0$ be the minimal polynomial of $T$. Then $d \leq n$ and $p(T)=0$. For any $v \in V$,
    ...
    We claim that $U$ is invariant under $T$. Take any $u=c_0 v+c_1 Tv+\cdots+c_{d-1} T^{d-1} v \in U$. Then,
