...
\begin{sol}
    Let $\alpha = a + bi$ and $\beta = c + di$ for some $a, b, c, d \in \r$.
	Then
    \begin{align*}
...
\begin{sol}
    Let $\alpha = a + bi$, $\beta = c + di$, and $\gamma = e + fi$ for some $a, b, c, d, e, f \in \r$.
	Then
    \begin{align*}
...
\begin{sol}
    Let $\alpha = a + bi$ for some $a, b \in \r$.
    ...
    To see that $\beta$ is unique, suppose there is another $\gamma \in \c$ such that $\alpha + \gamma = 0$.
	Then
...
\begin{sol}
    Let $x = (x_1, x_2, \ldots, x_n) \in \f^n$ and $a, b \in \f$.
	Then
    \begin{align*}
...
\begin{sol}
    Let $x = (x_1, x_2, \ldots, x_n) \in \f^n$.
	Then
    \begin{align*}
...
\begin{sol}
    Let $x = (x_1, x_2, \ldots, x_n)$ and $y = (y_1, y_2, \ldots, y_n)$ be elements of $\f^n$ and $\lambda \in \f$.
	Then
    \begin{align*}
