...
\begin{sol}
    ...
    \begin{subexercises}
	    ...
	    Hence, $U$ is not closed under addition and is not a subspace of $\fbb^3$.
        ...
        \]
        Hence, $au$ is in $U$.
	Therefore, $U$ is a subspace of $\fbb^3$. \qedhere
    \end{subexercises}
\end{sol}
...
\begin{exercise}[1c2]
    ...
    \begin{subexercises}
        \item If $b \in \fbb$, then
        \[
        	\set{(x_1, x_2, x_3, x_4) \in \fbb^4 \mid x_3 = 5x_4 + b}
        \]
        is a subspace of $\fbb^4$ if and only if $b = 0$.
        \item The set of continuous, real-valued functions on the interval $[0, 1]$ is a subspace of $\rbb^{[0, 1]}$.
        \item The set of differentiable real-valued functions on $\rbb$ is a subspace of $\rbb^{\rbb}$.
        \item The set of differentiable real-valued functions $f$ on the interval $(0, 3)$ such that $f'(2) = b$ is a subspace of $\rbb^{(0, 3)}$ if and only if $b = 0$.
        \item The set of all sequences of complex numbers with limit 0 is a subspace of $\cbb^\infty$.
    \end{subexercises}
\end{exercise}

\begin{sol}
    Let $U$ be the subset of $\fbb^4$ in question.
    \begin{subexercises}
        \item Suppose $U$ is a subspace of $\fbb^4$.
        ...
        The proof is similar to that of \exref{1c1} (d), hence $U$ is a subspace of $\fbb^4$.
        ...
        Therefore, $U$ is a subspace of $\rbb^{\rbb}$.
        \item Suppose $U$ is a subspace of $\rbb^{(0, 3)}$.
        Then it must contain the 0 function on $(0, 3)$.
        Then $0' = 0 = b$, which implies $b = 0$.
        
        Conversely, suppose $b = 0$.
        Then $U = \set{f \in \rbb^{(0, 3)} \mid f'(2) = 0}$.
        ...
        \]
        so $af \in U$.
        Therefore, $U$ is a subspace of $\rbb^{(0, 3)}$.
        ...
        \]
        so $a(z_n) \in U$.
        Therefore, $U$ is a subspace of $\cbb^\infty$. \qedhere
    \end{subexercises}
\end{sol}
...
\begin{sol}
    ...
    \]
    so $af \in U$.
	Therefore, $U$ is a subspace of $\rbb^{(-4, 4)}$.
\end{sol}
...
\begin{sol}
    Let $U$ be the set in question.
	Suppose $U$ is a subspace of $\rbb^{[0, 1]}$.
	...
	Then
    \[
    	U = \set*{f \in \rbb^{[0, 1]}\left|~\int_0^1 f = 0\right.}.
    \]
...
\begin{sol}
	...
	Let $u = (1, 0) \in \rbb^2$ and $a = i \in \cbb$.
