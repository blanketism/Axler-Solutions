...
\begin{soliff}
    ...
    \[
        \gen{Tv, v} = \gen{T^\ast v, v}. \qedhere
    \]
\end{soliff}
...
\begin{sol}
    ...
    \[
        \gen{(T^\ast T - TT^\ast)v, v} \geq 0 \quad \text{for all } v \in V.
    \]
    ...
    Then
    \[
        \sum_{i=1}^n \gen{Se_i, e_i} = \sum_{i=1}^n \gen{(T^\ast T - TT^\ast)e_i, e_i} = \sum_{i=1}^n \gen{T^\ast Te_i, e_i} - \sum_{i=1}^n \gen{TT^\ast e_i, e_i} = 0.
    \]
