...
\begin{sol}
    ...
    Since $v_1, \ldots, v_n$ is a basis, it follows that $\beta_k = 0$ for all $k \neq j$ and $\beta_j = \alpha_i$. Therefore, $Tv_j = \alpha_i v_j$. Since $i$ and $j$ were arbitrary, it follows that all $\alpha_k$ are equal, say $\alpha_k = \lambda$ for all $k$. Therefore, $Tv_k = \lambda v_k$ for all $k$, and hence $T = \lambda I$.
\end{sol}
