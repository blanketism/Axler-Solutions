...
\begin{sol}
	...
	Therefore, there exist scalars $\alpha_1, \ldots, \alpha_m \in \fbb$ such that
    \[
    ...
    \[
    	v' = \beta_1 n_1 + \cdots + \beta_k n_k
    \]
    for some scalars $\beta_1, \ldots, \beta_k \in \fbb$.
	Thus,
    \[
    ...
    \]
    for some scalars $\gamma_1, \ldots, \gamma_k, \delta_1, \ldots, \delta_m \in \fbb$.
